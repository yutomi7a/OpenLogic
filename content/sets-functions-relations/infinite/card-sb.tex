...
If $A \subseteq B \subseteq C$ and $\cardeq{A}{C}$, then $\cardeq{A}{B}$ and~$\cardeq{}{C}$.
\end{prop}
...
\[
	...
	\begin{cases}
		...
		\end{cases}
\]
We'll show that $g$ is !!a{bijection} from $C \to B$ (i.e.,
$\cardeq{B}{C}$). From this it will follow that $\comp{f^{-1}}{g}
\colon A \to B$ is !!a{bijection}, completing the proof ($\cardeq{A}{B}$).
